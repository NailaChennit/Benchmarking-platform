...
function see_unsee(id,label){
	    if($(id).attr('class')=='svg-inline--fa fa-eye fa-w-18'){
	    	$(id).attr('class','svg-inline--fa fa-eye-slash fa-w-18')
	    	$(label).attr('type','text')
	    }
	    else{
	    	$(id).attr('class','svg-inline--fa fa-eye fa-w-18')
